    ...
    try {
        ...
        while (true) {
            try {
                ...
                originalCatalogSnapshot.push(...catalog);
                ...
                for (const range of priceRanges) {
                    ...
                    addLog(`Lotes abertos na faixa ${stats.currentRange}: ${lotsInThisRange}`);
                }
                ...
                if (toScrape.length > 0 && !stopRequested.status) {
                    ...
                    const watchdogIntervalId = setInterval(() => {
                        ...
                        if (stats.progressCurrent === lastProgress) {
                            ...
                            throw new Error("Watchdog detectou travamento");
                        }
        ...
        if (browser.instance) {
            addLog("Limpando instâncias do navegador antes de encerrar...");
